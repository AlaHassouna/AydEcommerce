                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                          <label for="terms" class="font-light text-gray-500 dark:text-gray-300">J'accepte les <a class="font-medium text-[#011d28e6] hover:underline dark:text-white" href="#">Termes et conditions</a></label>
                        </div>
                    </div>
                    <button type="submit" class="w-full text-white bg-[#011d28] hover:bg-[#011d28e6] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-white dark:text-black ">Créer un compte</button>

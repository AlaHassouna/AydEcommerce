...
const ProductsPage = () => {
  ...
  const [currentPage, setCurrentPage] = useState(1);
    ...
    const [limit, setLimit]=useState(4)
      const [products, setProducts] = useState([]); // Initialisation avec une liste vide
    // const fetcharticles=async(page,limit)=>{
    //     try {
    //       const res=await axios.get(`http://127.0.0.1:8000/api/produitsPaginate?pageSize=${limit}&page=${page}`)
